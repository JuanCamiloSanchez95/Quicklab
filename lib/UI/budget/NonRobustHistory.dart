...
class  nonRobustHistory extends StatefulWidget{
  ...
  final String real;
  nonRobustHistory(this.email, this.uid, this.name, this.code, this.robust,this.noRobust,this.real);

  @override
  _nonRobustHistory  createState() => new _nonRobustHistory();
}

class _nonRobustHistory extends State<nonRobustHistory>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        title: new Text('Non-Robust History'),
        centerTitle: true,
      ...
      drawer: new Drawer(
        ...
        body: ListView(
            children: <Widget>[
              ...
              StreamBuilder(
                stream: db.collection('budgetExpenses').where('studentCode', isEqualTo: _email).where('accountType', isEqualTo: 'nonRobust').orderBy('date', descending: true).snapshots(),
