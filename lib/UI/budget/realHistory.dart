...
class  realHistory extends StatefulWidget{
  ...
  final String real;
  realHistory(this.email, this.uid, this.name, this.code, this.robust,this.noRobust,this.real);

  @override
  _realHistory  createState() => new _realHistory();
}

class _realHistory extends State<realHistory>{
  //STUDENT INFORMATION
  String _email;
  String _uid;
  String _name;
    ...
    return Scaffold(
        ...
        body: ListView(
            children: <Widget>[
              ...
              StreamBuilder(
                stream: FirebaseFirestore.instance.collection('budgetExpenses').where('studentCode', isEqualTo: _email).where('accountType', isEqualTo: 'real').orderBy('date', descending: true).snapshots(),
